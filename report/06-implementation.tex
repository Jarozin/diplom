...
\item для модифицированного метода --- поле \texttt{hierarchy} (иерархия групп), \texttt{elements\_data} (состав групп) и \texttt{comparisons} (парные сравнения для каждого контейнера).
\end{itemize}
