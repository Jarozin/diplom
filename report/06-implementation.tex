...
Метод \texttt{execute\_action} класса \texttt{InstructionGraph} представлен в листинге~\ref{lst:execute}.
...
Пример файла графового описания инструкции  представлен на рисунке~\ref{fig:graph}.
